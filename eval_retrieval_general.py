...
def compute_embeddings(encoder, lmdb_path, key_field_no: int = 1):
    """
    Compute embedding for all images in the lmdb database. Returns embeddings, and object ids.

    :param encoder: Encoder network
    :param lmdb_path: Path to lmdb database
    :return: embeddings, objet_ids
    """
    ...
    with env.begin(write=False) as txn:
        with torch.no_grad():
            ...
            for file_id, idx, cam_id in all_keys:
